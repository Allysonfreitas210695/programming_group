...
class FollowRequest(BaseModel):
    ...
    def clean(self):
        # Verificar se já há um relacionamento de seguimento existente
    ...
    # atualiza a request (solicitação e adiciona ou mantém o usuário que seguiu fora dos followers do usuário que recebeu a solicitação)
    def accept(self):  
